...
import { previewTemplateApplication } from "@/services/template-application-service";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const message = error instanceof Error ? error.message : "template_preview_apply_failed";
    const status =
