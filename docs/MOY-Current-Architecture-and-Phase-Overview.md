...
>
> 本文档反映的是 **Phase 18 (v1.5)** 的实际代码状态，是新读者和开发者的首选入口。
>
> - 当前对外交付版本：v1.5
> - 当前内部开发阶段：Phase 18 (v1.5)
> - 最新更新时间：2026-03-20
>
> **阅读顺序建议**：
>
...
| 标识           | 含义                           | 说明                                    |
| -------------- | ------------------------------ | --------------------------------------- |
| **Phase 18**   | 当前内部开发阶段               | 当前功能里程碑代号                      |
| **v1.0**       | 对外交付版本                   | 基于 Phase 16 打包的稳定发布            |
| **v1.1**       | 销售日常作战系统               | 已完成 P1 + P2                          |
| **v1.2**       | 销售经理作战台                 | Manager Desk P1-P3 完整闭环             |
| **v1.3**       | 介入效果分析与 Truth Band 校准 | Manager Insights MVP                    |
| **v1.4**       | 历史快照与校准层               | Snapshots 表 + Trends API + 趋势展示    |
| **v1.5**       | 自动化快照与趋势稳定化（当前） | pg_cron-ready + monthly 支持 + backfill |
...
| 模块              | 路由                   | 说明                                                         | 成熟度     | 版本        |
| ----------------- | ---------------------- | ------------------------------------------------------------ | ---------- | ----------- |
| Capture           | `/capture`             | 沟通内容捕获与提取 + 五处复用                                | ⭐⭐⭐⭐⭐ | v1.1        |
| Today             | `/today`               | 今日工作计划与任务 + 作战台                                  | ⭐⭐⭐⭐⭐ | v1.1        |
| Briefings         | `/briefings`           | 早报与简报生成                                               | ⭐⭐⭐⭐   | v1.0        |
...
| Manager Desk      | `/manager`             | 经理作战台（风险队列 + Pipeline 真相 + 介入建议 + 效果分析） | ⭐⭐⭐⭐   | v1.2 + v1.3 |
...
| **必读** | 本文档                                         | 当前架构总览                |
| **参考** | AGENTS.md                                      | 开发执行规范                |
| **参考** | docs/MOY-v1.1-Sales-Desk.md                    | v1.1 销售作战系统详情       |
| **参考** | docs/MOY-v1.2-Manager-Desk.md                  | v1.2 经理作战台详情         |
| **参考** | docs/MOY-v1.3-Manager-Insights.md              | v1.3 介入效果分析详情       |
| **参考** | docs/MOY-v1.4-Snapshots-and-Calibration.md     | v1.4 历史快照与校准层       |
| **参考** | docs/MOY-v1.5-Automated-Snapshots.md           | v1.5 自动化快照与趋势稳定化 |
